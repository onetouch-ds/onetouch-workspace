# Generated by Django 2.2 on 2020-10-04 07:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mj_promise1', models.CharField(blank=True, max_length=45, null=True)),
                ('mj_promise2', models.CharField(blank=True, max_length=45, null=True)),
                ('mj_promise3', models.CharField(blank=True, max_length=45, null=True)),
                ('mj_promise4', models.CharField(blank=True, max_length=45, null=True)),
            ],
            options={
                'db_table': 'major_vote',
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sh_promise1', models.CharField(blank=True, max_length=45, null=True)),
                ('sh_promise2', models.CharField(blank=True, max_length=45, null=True)),
                ('sh_promise3', models.CharField(blank=True, max_length=45, null=True)),
                ('sh_promise4', models.CharField(blank=True, max_length=45, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ud_promise1', models.CharField(blank=True, max_length=45, null=True)),
                ('ud_promise2', models.CharField(blank=True, max_length=45, null=True)),
                ('ud_promise3', models.CharField(blank=True, max_length=45, null=True)),
                ('ud_promise4', models.CharField(blank=True, max_length=45, null=True)),
            ],
            options={
